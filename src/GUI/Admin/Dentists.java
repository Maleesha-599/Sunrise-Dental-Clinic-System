 ...
 * @author Lenovo
 */
public class Dentists extends javax.swing.JInternalFrame {
    ...
    public Dentists(java.awt.Frame parent) {
        initComponents();
    ...
    private void deleteSelectedRow() {
        ...
        int confirm = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete this dentist?", "Confirm Delete", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);

        if (confirm == JOptionPane.YES_OPTION) {

            try {

                selectedUserId = String.valueOf(jTable1.getModel().getValueAt(row, 7));

                MySQL.executeIUD("DELETE FROM dentist "
                        + "WHERE dentist.System_user_user_id = '" + selectedUserId + "'");

                MySQL.executeIUD("DELETE FROM system_user "
                        + "WHERE system_user.user_id = '" + selectedUserId + "'");
    ...
    private void applyFilters() {
        ...
        if (!search.isEmpty()) {
            filters.add(RowFilter.regexFilter("(?i)" + Pattern.quote(search), 0, 1, 5));
        }

        if (!status.equals("Select")) {
            filters.add(RowFilter.regexFilter("^" + Pattern.quote(status) + "$", 6));
        }
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Dentists");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dentists Registration", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Variable", 1, 14), new java.awt.Color(5, 125, 165))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "All Dentists", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Variable", 1, 14), new java.awt.Color(5, 125, 165))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (name.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(this, "Please enter Doctor's specialisation", "Warning", JOptionPane.WARNING_MESSAGE);
            ...
            if (contactNumber.isEmpty()) {
                ...
                ResultSet resultSet = MySQL.executeSearch("SELECT COUNT(*) FROM dentist INNER JOIN system_user ON dentist.System_user_user_id = system_user.user_id WHERE system_user.contact_no = '" + contactNumber + "'");

                if (resultSet.next() && resultSet.getInt(1) > 0) {

                    JOptionPane.showMessageDialog(this, "This Dentist is already Registered", "Warning", JOptionPane.WARNING_MESSAGE);
                    jTextField1.grabFocus();
                    ...
                    ResultSet resultSet2 = MySQL.executeSearch("SELECT LAST_INSERT_ID()");
                    ...
                    MySQL.executeIUD("INSERT INTO dentist (dentist_name, specialization, contact_no, email, Status_status_id, System_user_user_id) "
                            + "VALUES ('" + name + "', '" + specialization + "', '" + contactNumber + "', '" + email + "', '" + statusId + "', '" + userId + "')");

                    JOptionPane.showMessageDialog(this, "Dentist Registered Successfully");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            MySQL.executeIUD("UPDATE dentist SET dentist_name='" + name + "', "
                    + "specialization='" + specialization + "', contact_no='" + contactNumber + "', "
                    + "email='" + email + "', Status_status_id='" + statusId + "', "
                    + "System_user_user_id='" + selectedUserId + "' "
                    + "WHERE dentist.System_user_user_id = '" + selectedUserId + "'");

            JOptionPane.showMessageDialog(this, "Dentist details Updated Successfully");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            jComboBox1.setSelectedItem("Dentist");

            jComboBox2.setSelectedItem(String.valueOf(jTable1.getModel().getValueAt(row, 6)));
